...
qx.Class.define("ncms.asm.am.ImageAM", {
    ...
    members : {
        ...
        activateOptionsWidget : function(attrSpec, asmSpec) {
            ...
            form.add(wTb, this.tr("Width"), sm.util.Validate.canBeRangeNumber(10, 2048), "width");

            var hTb = new qx.ui.form.TextField().set({maxLength : 3});
            if (opts["height"] != null) {
                hTb.setValue(opts["height"]);
            }
            form.add(hTb, this.tr("Height"), sm.util.Validate.canBeRangeNumber(10, 2048), "height");

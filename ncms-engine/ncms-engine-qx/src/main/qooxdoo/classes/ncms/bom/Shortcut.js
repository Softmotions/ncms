/**
 * Alternative shortcuts can be used for specified elements.
 */
qx.Class.define("ncms.bom.Shortcut", {
     ...
     *
     * @param target {Object|null} target element for shortcut.
     *    If <code>null</code> shortcut will be add to global context.
     */
    construct: function (shortcut, target) {
        this.base(arguments);

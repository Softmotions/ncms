...
function initWearherChart(){$('\x3cdiv id\x3d"wchart-blackout"\x3e\x3cdiv class\x3d"wchart-container"\x3e\x3cimg src\x3d"/images/loader.gif"                           class\x3d"loader" /\x3e\x3ca href\x3d"http://weather.nsu.ru/"                         target\x3d"_blank"\x3e\x3cimg class\x3d"wchart"/\x3e\x3c/a\x3e\x3c/div\x3e\x3c/div\x3e').appendTo("body");var a=$("#wchart-blackout"),e=$(".wchart-container"),c=$(".loader"),b=$(".wchart");a.click(function(){a.fadeOut(250)});b.imagesLoaded(function(){c.hide();
b.fadeIn(250)});var f=$("#curr-temp"),d=f.parent();d.click(function(c){a.fadeIn(250);e.css({position:"absolute",top:c.pageY,left:c.pageX});b.attr("src","/rs/weather/chart?"+(new Date).getTime())});$.get("/rs/weather/currtemp?"+(new Date).getTime(),function(a){f.html(a+"℃");d.show()})};
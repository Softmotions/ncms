...
function initNewsMain(a){var e=$("div#news-container"),c=$("a#news-fetch-more");e.imagesLoaded(function(){e.masonry({itemSelector:".news-item"})});c.click(function(){var b=e.find(".news-item").size();c.hide();$.post(null,{"mnc.action":"fetchMoreNews","mnc.news.skip":b,"mnc.news.limit":a},function(f){var d=$.parseHTML(f);e.append(d);e.imagesLoaded(function(){e.masonry("appended",d)});e.find(".news-item").size()-b>=a&&c.fadeIn(500)});return!1});c.hide();e.find(".news-item").size()>=a&&c.show()}
...
function initEventsMain(a,e){var c=$("ul.event-list"),b=$("a.fetch-more");c.imagesLoaded(function(){c.masonry({itemSelector:"li"})});b.click(function(){var f=c.find("li").size();b.hide();$.post(a,{"news.action":"fetchMore","news.skip":f,"news.limit":e},function(a){var l=$.parseHTML(a);c.append(l);c.imagesLoaded(function(){c.masonry("appended",l)});c.find("li").size()-f>=e&&b.fadeIn(500)});return!1});b.hide();c.find("li").size()>=e&&b.show()}
...
function initWearherChart(){var a=jQuery("\x3cdiv/\x3e",{id:"blackout",style:"width: 100%; height: 100%; position: fixed;                    left: 0; top: 0; display: none; z-index: 10000;"});a.appendTo("body");a.click(function(){a.fadeOut(250)});var e=jQuery("\x3cdiv/\x3e",{id:"wchart-container",style:"width: 500px; height:300px; background: #eeeeee;                     margin: 0 0 0 -500px; "});e.appendTo(a);var c=jQuery("\x3ca/\x3e",{href:"http://weather.nsu.ru/",target:"_blank"});c.appendTo(e);
var b=jQuery("\x3cimg/\x3e",{src:"/images/loader.gif",style:"position: absolute; top: 50%; left: 50%;                     margin: -5px 0 0 -21px"});b.appendTo(e);var f=jQuery("\x3cimg/\x3e",{id:"wchart",style:"display: none; border: 1px solid #1a1a1a;"});f.appendTo(c);f.imagesLoaded(function(){b.hide();f.fadeIn(250)});var d=$("#curr-temp");$.get("/rs/weather/currtemp?"+(new Date).getTime(),function(a){d.html(a+"℃")}).done(function(){var b=d.parent();b.show();b.click(function(b){a.fadeIn(250);e.css({position:"absolute",
top:b.pageY,left:b.pageX});f.attr("src","/rs/weather/chart?"+(new Date).getTime())})})};
...
function initWearherChart(){var a=jQuery("\x3cdiv/\x3e",{id:"blackout",style:"width: 100%; height: 100%; position: fixed;                    left: 0; top: 0; display: none; z-index: 10000;"});a.appendTo("body");a.click(function(){a.fadeOut(250)});var e=jQuery("\x3cdiv/\x3e",{id:"wchart-container",style:"margin: 0 0 0 -500px; border: 1px solid #1a1a1a"});e.appendTo(a);var c=jQuery("\x3cimg/\x3e",{id:"wchart",style:"display: block"});c.appendTo(e);c.click(function(){window.open("http://weather.nsu.ru/")});
var b=$("#curr-temp");$.get("/rs/weather/currtemp?"+(new Date).getTime(),function(a){b.html(a+"℃")}).done(function(){var f=b.parent();f.show();f.click(function(b){a.fadeIn(250);e.css({position:"absolute",top:b.pageY,left:b.pageX});c.attr("src","/rs/weather/chart?"+(new Date).getTime())})})};
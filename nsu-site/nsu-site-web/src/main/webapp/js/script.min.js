...
function initWearherChart(){$.get("/rs/weather/currtemp",function(a){$("#curr-temp").html(a+"℃")}).done(function(){var a=$("#curr-temp").parent();a.show();a.click(function(){jQuery("\x3cdiv/\x3e",{id:"blackout",style:"width: 100%; height: 100%; position: fixed;                         top: 0%; left: 0%; background: rgba(192, 192, 192, .85)"}).appendTo("body");$("#blackout").click(function(){$("#wchart").remove();$(this).remove()});jQuery("\x3cdiv/\x3e",{id:"wchart",style:"position: fixed; top: 10%; left: 30%;                         border: 1px solid #1a1a1a"}).appendTo("body");
jQuery("\x3cimg/\x3e",{src:"/rs/weather/chart",style:"display: block"}).appendTo("#wchart")})})};
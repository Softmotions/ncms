...
function initRemember(){$(".event-list .remember").click(function(a){$(".remember-form").fadeOut(200);var e=$(this).closest("li").find(".remember-form"),c=e.find("input[name\x3dcontact]");c.val("");c.focus();e.fadeIn(200);a.preventDefault()});$(".remember-form .close").click(function(a){$(".remember-form").fadeOut(200);a.preventDefault()});$(".remember-form").submit(function(a){a.preventDefault();var e=$(a.target);if(""!=$.trim(e.find("input[name\x3dcontact]").val())){var c=e.serializeArray();c.push({name:"action",
value:"remember"});$.post(a.target.action,c,function(a){a.success?(e.find("input[type\x3dtext]").val(""),e.parent().find(".remember").hide(),e.fadeOut(500)):alert(a.message||"Ошибка сохранения напоминания")}).fail(function(){})}})}

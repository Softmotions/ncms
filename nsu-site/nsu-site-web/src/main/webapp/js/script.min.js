...
function initWearherChart(){$.get("/rs/weather/currtemp",function(a){$("#curr-temp").html(a+"℃")}).done(function(){var a=$("#curr-temp").parent();a.show();a.click(function(){$("#wchart").attr("src","/rs/weather/chart")})})};
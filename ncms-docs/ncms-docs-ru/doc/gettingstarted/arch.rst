...
Страница в ηCMS совокупность **данных** и **HTML разметки**.
...
.. glossary::
    ...
    HTTL
        Язык разметки (http://httl.github.io) с помощью которого определяется :term:`разметка <ядро>` страниц ηCMS.
...
Давайте реализуем описанную выше структуры в графическом интерфейсе ηCMS
...
имел возможность расширять функционал как самой платформы ηCMS в контексте проекта,

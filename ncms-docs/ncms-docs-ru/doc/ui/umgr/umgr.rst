...
По умолчанию в nCMS используется база данных пользователей, хранящая данные в XML файле.

.. note::

    nCMS позволяет подключать любую другую базу данных пользователей, реализующую
...
.. code-block:: xml
    ...
    <security>
        ...
        <!-- Алгоритм для генерации хешей для паролей в XML
             базе данных пользователей nCMS.
             Возможные значения:
                - sha256
                - bcrypt

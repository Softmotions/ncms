...
Ссылка на файл медиарепозитория nCMS (fileref)
==============================================
...
Опция                              Описание
================================== =========
**Местоположение**                 Местоположение файла в медаиарепозитории nCMS.
**Отображать как шаблон**          Если данная опция включена контент файла будет интерпретирован как :ref:`HTTL <httl>` шаблон

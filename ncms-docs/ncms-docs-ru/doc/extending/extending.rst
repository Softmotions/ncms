...
nCMS инсталлируется в форме :ref:`создания проекта <newproject>`
веб приложения на java платформе. Тем самым, пользователь nCMS
...
Структура нового nCMS проекта в случае если имя проекта `myncms`::
...
Клиентская часть административной зоны nCMS реализована
на базе javascript фреймворка Qooxdoo http://qooxdoo.org

Стартовый класс qooxdoo приложения административной зоны nCMS
...
функционал административной зоны nCMS

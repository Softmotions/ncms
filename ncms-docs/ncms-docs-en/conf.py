...
latex_documents = [
    (master_doc, 'NCMS.tex', 'NCMS Documentation',
     'Adamansky Anton', 'manual'),
]
...
man_pages = [
    (master_doc, 'ncms', 'NCMS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NCMS', 'NCMS Documentation',
     author, 'NCMS', 'One line description of project.',
   'Miscellaneous'),
]
